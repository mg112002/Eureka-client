...
export default {
    ...
    data() {
        return {
            ...
            blogs: [{
                ...
                upvotedBy: ['a', 'b', 'c'],
                downvotedBy: ['d'],
                tags: ['Hello1', 'Hello123', 'Hello1234', 'Hello1345363455tttttt'],
                category:'C++'
            }, {
    ...
    methods: {
        // async getResults() {
        //     //request blogs with the keyword
        // }
        setBlogs() {
            ...
            if (blogs) {
                ...
                this.$router.push({name:'blogs',query:{search:this.search}})
            }
